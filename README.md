...
is the active implementation slice; server-side game validation is complete,
and authenticated game operations are next before the playable chessboard flow.
